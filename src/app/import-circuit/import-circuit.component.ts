...
declare var $: any;
@Component({
  selector: 'app-import-circuit',
  templateUrl: './import-circuit.component.html',
  styleUrls: ['./import-circuit.component.css']
})
export class ImportCircuitComponent implements OnInit {
  data: any[] = [];
  message: string;
  constructor(private empService:CircuitService) { }
