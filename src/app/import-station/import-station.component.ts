...
@Component({
  selector: 'app-import-station',
  templateUrl: './import-station.component.html',
  styleUrls: ['./import-station.component.css']
})
export class ImportStationComponent implements OnInit {
  data: any[] = [];
  message: string;
  constructor(private empService:StationService) { }
