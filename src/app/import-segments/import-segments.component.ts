...
@Component({
  selector: 'app-import-segments',
  templateUrl: './import-segments.component.html',
  styleUrls: ['./import-segments.component.css']
})
export class ImportSegmentsComponent implements OnInit {

  data: any[] = [];
  message: string;
  constructor(private empService:SegService) { }
